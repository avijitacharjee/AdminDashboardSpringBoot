...
import com.example.springboot.demo.echarts.GridExample;
...
public class EChartsController {
	...
	@GetMapping("/grid")
	public String gridExample(Model model) throws JsonProcessingException {
		String data = GridExample.getGridData();
		model.addAttribute("message", data);
		return "examples/echarts/grid";
	}
